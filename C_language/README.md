...
<h3 align="center"># C Language Programs 🚀 This repository contains my practice codes for learning *C programming*. Programs are organized into folders based on topic, starting from basics and moving towards loops and patterns. ## 📂 Folder Structure → basic_c_programs →loops_and_pattern →c_arrays_strings_pointers</h3>
